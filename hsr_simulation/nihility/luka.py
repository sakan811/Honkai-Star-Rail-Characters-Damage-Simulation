...
class Luka(Character):
    ...
    def _use_ult(self) -> None:
        ...
        if self.ult_buff > 0:
            dmg, break_amount = self._calculate_damage(skill_multiplier=3.3, break_amount=30,
                                                       dmg_multipliers=[0.2])
        else:
            dmg, break_amount = self._calculate_damage(skill_multiplier=3.3, break_amount=30)
    ...
    def _apply_bleed(self, talent_trigger: bool = False) -> None:
        ...
        if self.ult_buff > 0:
            dmg, break_amount = self._calculate_damage(break_amount=0, dmg_multipliers=[0.2],
                                                       can_crit=False, is_bleed=True)
        else:
            dmg, break_amount = self._calculate_damage(break_amount=0, can_crit=False, is_bleed=True)
    ...
    def _use_enhanced_basic_atk(self) -> None:
        ...
        for _ in range(3):
            dmg, break_amount = self._calculate_damage(skill_multiplier=0.2, break_amount=20,
            ...
            if random.random() < 0.5:
                additional_dmg, break_amount = self._calculate_damage(skill_multiplier=0.2, break_amount=20,
                                                                      dmg_multipliers=dmg_multiplier)
            else:
                additional_dmg = 0
            dmg += additional_dmg
    ...
    def random_enemy_hp(self) -> None:
        ...
        self.enemy_hp = random.randint(338, 1500)
    ...
    def _calculate_damage(
            ...
            can_crit: bool = True,
            is_bleed: bool = False) -> tuple[float, int]:
        """
