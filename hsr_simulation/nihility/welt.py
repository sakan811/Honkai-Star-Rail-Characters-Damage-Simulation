...
from hsr_simulation.dmg_calculator import calculate_base_dmg, calculate_dmg_multipliers, \
    calculate_universal_dmg_reduction, calculate_total_damage, calculate_res_multipliers, calculate_def_multipliers
...
class Welt(Character):
    ...
    def _use_skill(self) -> None:
        ...
        for _ in range(num_hit):
            dmg_multiplier = self._apply_a2_trace()
            dmg = self._calculate_damage(skill_multiplier=0.72, break_amount=10,
                                         dmg_multipliers=dmg_multiplier)
