...
class Jingyuan(Character):
    def __init__(self, speed: float = 99, ult_energy: int = 130):
    ...
    def summon_lightning_lord(
        self, jingyuan: "Jingyuan", speed: int = 60
    ) -> "LightingLord":
        """
...
class LightingLord(Character):
    def __init__(self, jingyuan: Jingyuan, speed: float = 60, ult_energy: int = 0):
        super().__init__(speed=speed, ult_energy=ult_energy)
    ...
    def take_action(self) -> None:
        ...
        increased_hit_per_action = (
            self.jingyuan.lighting_lord_hit_per_action - 3
            if self.jingyuan.lighting_lord_hit_per_action > 3
            else 0
        )
    ...
    def _calculate_damage(
        ...
        dmg_reduction = calculate_universal_dmg_reduction(
            self.jingyuan.enemy_weakness_broken
        )
