...
def test_process_result_list_valid_input(
    mock_character, sample_dict_list, stage_table_name
):
    """Test process_result_list with valid inputs"""
    with (
        patch("hsr_simulation.utils.create_df_from_dict_list") as mock_create_df,
