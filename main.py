...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--paths', type=str, nargs='+', choices=['Hunt', 'Nihility', 'Destruction', 'Erudition', 'Harmony'],
                      help='Specify which paths to simulate. If not provided, all paths will be simulated.')
    parser.add_argument('--sim-count', type=int, default=1000,
...
if __name__ == '__main__':
    ...
    paths_to_run = args.paths if args.paths else ['Hunt', 'Nihility', 'Destruction', 'Erudition', 'Harmony']
